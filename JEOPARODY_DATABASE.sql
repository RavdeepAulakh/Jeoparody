...
-- Spanish Questions
INSERT INTO Questions (category_id, language_id, question_text, image_location_data) VALUES
(6, 2, 'Este legendario boxeador originalmente se llamaba Cassius Clay.', '/path/to/image1.jpg'),
(6, 2, 'Esta actriz protagonizó la película "Desayuno con diamantes".', '/path/to/image2.jpg'),
(6, 2, 'Esta actriz y cantante interpretó a Sandy en la película "Grease".', '/path/to/image3.jpg'),
(6, 2, 'Este director es conocido por la película "E.T. el Extraterrestre" en los años 80.', '/path/to/image4.jpg'),
(6, 2, 'Él fue conocido como el "Rey del Pop".', '/path/to/image5.jpg'),
(6, 2, 'Esta actriz interpretó a la Princesa Leia en la serie "Star Wars".', '/path/to/image6.jpg'),
(6, 2, 'Este legendario guitarrista tocó el himno nacional en Woodstock en 1969.', '/path/to/image7.jpg'),
(6, 2, 'Se hizo famoso por interpretar el papel de "El Terminator" en la película de 1984.', '/path/to/image8.jpg'),
(6, 2, 'Esta ícono del pop se convirtió en la "Reina del Pop" durante los años 80.', '/path/to/image9.jpg'),
(6, 2, 'Este líder sudafricano fue liberado de prisión en 1990 después de 27 años.', '/path/to/image10.jpg');

-- French Questions
INSERT INTO Questions (category_id, language_id, question_text, image_location_data) VALUES
(11, 3, 'Ce boxeur légendaire s’appelait à l’origine Cassius Clay.', '/path/to/image1.jpg'),
(11, 3, 'Cette actrice a joué dans le film "Diamants sur canapé".', '/path/to/image2.jpg'),
(11, 3, 'Cette actrice et chanteuse a interprété Sandy dans le film "Grease".', '/path/to/image3.jpg'),
(11, 3, 'Ce réalisateur est connu pour le film "E.T. l’extra-terrestre" des années 80.', '/path/to/image4.jpg'),
(11, 3, 'Il était connu comme le "Roi de la Pop".', '/path/to/image5.jpg'),
(11, 3, 'Cette actrice a joué la Princesse Leia dans la série "Star Wars".', '/path/to/image6.jpg'),
(11, 3, 'Ce guitariste légendaire a joué l’hymne national à Woodstock en 1969.', '/path/to/image7.jpg'),
(11, 3, 'Il est devenu célèbre pour avoir joué le rôle de "Terminator" dans le film de 1984.', '/path/to/image8.jpg'),
(11, 3, 'Cette icône de la pop est devenue la "Reine de la Pop" dans les années 80.', '/path/to/image9.jpg'),
(11, 3, 'Ce leader sud-africain a été libéré de prison en 1990 après 27 ans.', '/path/to/image10.jpg');
...
INSERT INTO Questions (category_id, language_id, question_text, image_location_data) VALUES
(7, 2, 'En 1969, los humanos pisaron la Luna por primera vez durante esta misión.', '/path/to/image11.jpg'),
(7, 2, 'En 1991, la disolución de esta federación marcó el fin de la era de la Guerra Fría.', '/path/to/image12.jpg'),
(7, 2, 'La Ley de Derechos Civiles, que buscaba poner fin a la segregación en lugares públicos y prohibía la discriminación laboral, fue promulgada en este año.', '/path/to/image13.jpg'),
(7, 2, 'En 1962, EE.UU. y la Unión Soviética estuvieron al borde de una guerra nuclear debido a misiles en este país.', '/path/to/image14.jpg'),
(7, 2, 'Esta operación de 1991 fue una guerra liderada por una coalición contra Iraq tras su invasión a Kuwait.', '/path/to/image15.jpg'),
(7, 2, 'Este concierto celebrado en 1985 tuvo como objetivo recaudar fondos para aliviar la hambruna en Etiopía.', '/path/to/image16.jpg'),
(7, 2, 'Este presidente estadounidense fue sometido a juicio político en 1998 pero no fue destituido.', '/path/to/image17.jpg'),
(7, 2, 'Este escándalo a principios de la década de 1970 involucró la campaña de bombardeo secreta del gobierno de EE.UU. durante la Guerra de Vietnam.', '/path/to/image18.jpg'),
(7, 2, 'Este Presidente de EE.UU. promulgó la Ley de Derechos Civiles de 1964.', '/path/to/image19.jpg'),
(7, 2, 'En 1997, el Reino Unido cedió la soberanía de este territorio a China.', '/path/to/image20.jpg');

-- French Translations
INSERT INTO Questions (category_id, language_id, question_text, image_location_data) VALUES
(12, 3, 'En 1969, les humains ont mis le pied sur la Lune pour la première fois lors de cette mission.', '/path/to/image11.jpg'),
(12, 3, 'En 1991, la dissolution de cette fédération a marqué la fin de l\'ère de la Guerre Froide.', '/path/to/image12.jpg'),
(12, 3, 'La loi sur les droits civiques, visant à mettre fin à la ségrégation dans les lieux publics et interdisant la discrimination à l\'emploi, a été promulguée cette année.', '/path/to/image13.jpg'),
(12, 3, 'En 1962, les États-Unis et l\'Union Soviétique étaient au bord de la guerre nucléaire en raison de missiles dans ce pays.', '/path/to/image14.jpg'),
(12, 3, 'Cette opération de 1991 était une guerre menée par une coalition contre l\'Irak suite à son invasion du Koweït.', '/path/to/image15.jpg'),
(12, 3, 'Ce concert organisé en 1985 visait à lever des fonds pour l\'aide contre la famine en Éthiopie.', '/path/to/image16.jpg'),
(12, 3, 'Ce président américain a été destitué en 1998 mais n\'a pas été écarté du pouvoir.', '/path/to/image17.jpg'),
(12, 3, 'Ce scandale au début des années 1970 concernait la campagne de bombardements secrets du gouvernement américain pendant la guerre du Vietnam.', '/path/to/image18.jpg'),
(12, 3, 'Ce président des États-Unis a signé la loi sur les droits civiques de 1964.', '/path/to/image19.jpg'),
(12, 3, 'En 1997, le Royaume-Uni a rendu la souveraineté de ce territoire à la Chine.', '/path/to/image20.jpg');
...
-- Spanish Translations
INSERT INTO Questions (category_id, language_id, question_text, image_location_data) VALUES
(8, 2, 'Este muscle car americano fue introducido por Ford en 1964.', '/path/to/image21.jpg'),
(8, 2, 'El Acura NSX de 1991 fue notable por el uso de este material ligero en su chasis.', '/path/to/image22.jpg'),
(8, 2, 'En 1983, esta compañía americana de automóviles introdujo la minivan, revolucionando el transporte familiar.', '/path/to/image23.jpg'),
(8, 2, '¿Qué fabricante británico de coches produjo el lujoso modelo Silver Shadow en la década de 1960?', '/path/to/image24.jpg'),
(8, 2, 'El Subaru Impreza WRX, introducido en la década de 1990, fue especialmente popular en este tipo de carreras.', '/path/to/image25.jpg'),
(8, 2, '¿Qué fabricante italiano de coches introdujo el Countach en 1974?', '/path/to/image26.jpg'),
(8, 2, '¿Qué marca japonesa de coches de lujo fue lanzada por Toyota en 1989?', '/path/to/image27.jpg'),
(8, 2, '¿Qué fabricante de coches produjo el modelo 911, introducido por primera vez a principios de la década de 1960?', '/path/to/image28.jpg'),
(8, 2, 'Este fabricante sueco de automóviles introdujo la serie 240 centrada en la seguridad en la década de 1970.', '/path/to/image29.jpg'),
(8, 2, 'Honda introdujo este modelo en 1972, que desde entonces se ha convertido en uno de los coches más vendidos en el mundo.', '/path/to/image30.jpg');

-- French Translations
INSERT INTO Questions (category_id, language_id, question_text, image_location_data) VALUES
(13, 3, 'Cette voiture muscle américaine a été introduite par Ford en 1964.', '/path/to/image21.jpg'),
(13, 3, 'La Acura NSX de 1991 était notable pour l\'utilisation de ce matériau léger dans son châssis.', '/path/to/image22.jpg'),
(13, 3, 'En 1983, cette compagnie automobile américaine a introduit le monospace, révolutionnant le transport familial.', '/path/to/image23.jpg'),
(13, 3, 'Quel constructeur automobile britannique a produit le modèle de luxe Silver Shadow dans les années 1960?', '/path/to/image24.jpg'),
(13, 3, 'La Subaru Impreza WRX, introduite dans les années 1990, était particulièrement populaire dans ce type de course.', '/path/to/image25.jpg'),
(13, 3, 'Quel constructeur automobile italien a introduit la Countach en 1974?', '/path/to/image26.jpg'),
(13, 3, 'Quelle marque japonaise de voitures de luxe a été lancée par Toyota en 1989?', '/path/to/image27.jpg'),
(13, 3, 'Quel constructeur automobile a produit le modèle 911, introduit pour la première fois au début des années 1960?', '/path/to/image28.jpg'),
(13, 3, 'Ce constructeur automobile suédois a introduit la série 240 axée sur la sécurité dans les années 1970.', '/path/to/image29.jpg'),
(13, 3, 'Honda a introduit ce modèle en 1972, qui est depuis devenu l\'une des voitures les plus vendues au monde.', '/path/to/image30.jpg');
...
-- Spanish Translations
INSERT INTO Questions (category_id, language_id, question_text, image_location_data) VALUES
(9, 2, 'Esta banda, conocida por éxitos como "Hey Jude" y "Let It Be", es a menudo considerada la banda de rock más influyente de todos los tiempos.', '/path/to/image31.jpg'),
(9, 2, 'En 1991, ¿qué banda lanzó el álbum "Nevermind" que incluye el éxito "Smells Like Teen Spirit"?', '/path/to/image32.jpg'),
(9, 2, '¿Qué artista lanzó el icónico álbum "Thriller" en 1982?', '/path/to/image33.jpg'),
(9, 2, 'La canción "Stayin'' Alive" fue un éxito para este grupo y se destacó en la película "Fiebre del sábado noche".', '/path/to/image34.jpg'),
(9, 2, 'La canción "Purple Rain" de 1984 es una pista del álbum del mismo nombre de este artista.', '/path/to/image35.jpg'),
(9, 2, '¿Qué banda, liderada por Freddie Mercury, lanzó éxitos como "Bohemian Rhapsody" y "We Are The Champions"?', '/path/to/image36.jpg'),
(9, 2, 'Esta banda de rock, conocida por su distintivo sonido de guitarra, lanzó "Hotel California" en 1976.', '/path/to/image37.jpg'),
(9, 2, 'La actuación de este artista en 1969 en Woodstock, donde interpretó una versión de "The Star-Spangled Banner", es legendaria.', '/path/to/image38.jpg'),
(9, 2, 'Este cantante jamaicano es conocido como el "Rey del Reggae" y tuvo éxitos como "No Woman, No Cry" y "Redemption Song".', '/path/to/image39.jpg'),
(9, 2, '¿Qué banda británica lanzó el aclamado álbum "The Dark Side of the Moon" en 1973?', '/path/to/image40.jpg');

-- French Translations
INSERT INTO Questions (category_id, language_id, question_text, image_location_data) VALUES
(14, 3, 'Ce groupe, connu pour des hits comme "Hey Jude" et "Let It Be", est souvent considéré comme le groupe de rock le plus influent de tous les temps.', '/path/to/image31.jpg'),
(14, 3, 'En 1991, quel groupe a sorti l''album "Nevermind" avec le hit "Smells Like Teen Spirit"?', '/path/to/image32.jpg'),
(14, 3, 'Quel artiste a sorti l''album iconique "Thriller" en 1982?', '/path/to/image33.jpg'),
(14, 3, 'La chanson "Stayin'' Alive" a été un succès pour ce groupe et a été mise en avant dans le film "Saturday Night Fever".', '/path/to/image34.jpg'),
(14, 3, 'La chanson de 1984 "Purple Rain" est un morceau de l''album du même nom de cet artiste.', '/path/to/image35.jpg'),
(14, 3, 'Quel groupe, dirigé par Freddie Mercury, a sorti des hits comme "Bohemian Rhapsody" et "We Are The Champions"?', '/path/to/image36.jpg'),
(14, 3, 'Ce groupe de rock, connu pour son son de guitare distinctif, a sorti "Hotel California" en 1976.', '/path/to/image37.jpg'),
(14, 3, 'La performance de cet artiste en 1969 à Woodstock, où il a joué une version de "The Star-Spangled Banner", est légendaire.', '/path/to/image38.jpg'),
(14, 3, 'Ce chanteur jamaïcain est connu comme le "Roi du Reggae" et a eu des hits comme "No Woman, No Cry" et "Redemption Song".', '/path/to/image39.jpg'),
(14, 3, 'Quel groupe britannique a sorti l''album acclamé par la critique "The Dark Side of the Moon" en 1973?', '/path/to/image40.jpg');
...
-- Spanish Translations
INSERT INTO Questions (category_id, language_id, question_text, image_location_data) VALUES
(10, 2, 'A finales de la década de 1960, esta tendencia de moda se inspiró en el diseño de la era espacial y a menudo presentaba materiales metálicos y formas geométricas.', '/path/to/image41.jpg'),
(10, 2, 'Esta tendencia de moda de finales de la década de 1980 y principios de la de 1990 involucraba cuentas de colores brillantes y formas de plástico usadas como collares.', '/path/to/image42.jpg'),
(10, 2, 'En la década de 1960, esta diseñadora de moda británica popularizó la minifalda.', '/path/to/image43.jpg'),
(10, 2, '¿Qué tipo de joyería, a menudo usada en la década de 1980, involucraba múltiples pulseras de goma usadas al mismo tiempo, popularizadas por Madonna?', '/path/to/image44.jpg'),
(10, 2, 'En la década de 1980, las mujeres a menudo usaban tops grandes con pantalones o leggings ajustados y este tipo de calzado.', '/path/to/image45.jpg'),
(10, 2, '¿Qué marca de bolsos se hizo famosa en la década de 1980 por sus bolsos acolchados con una correa de cadena?', '/path/to/image46.jpg'),
(10, 2, 'En la década de 1970, ¿qué accesorio se popularizó, caracterizado por su forma redonda y lentes coloreadas, a menudo espejadas?', '/path/to/image47.jpg'),
(10, 2, 'En la década de 1980, las chaquetas "Members Only" se convirtieron en un artículo de moda popular. ¿Qué característica distintiva tenían?', '/path/to/image48.jpg'),
(10, 2, 'Estos collares, a menudo hechos de cuentas de plástico, se convirtieron en un accesorio popular en la década de 1990.', '/path/to/image49.jpg'),
(10, 2, 'En la década de 1970, estos pantalones acampanados se convirtieron en un elemento básico de la moda.', '/path/to/image50.jpg');

-- French Translations
INSERT INTO Questions (category_id, language_id, question_text, image_location_data) VALUES
(15, 3, 'À la fin des années 1960, cette tendance mode a été inspirée par le design de l''âge spatial et comportait souvent des matériaux métalliques et des formes géométriques.', '/path/to/image41.jpg'),
(15, 3, 'Cette tendance mode de la fin des années 1980 et du début des années 1990 comportait des perles et des formes en plastique de couleurs vives portées en colliers.', '/path/to/image42.jpg'),
(15, 3, 'Dans les années 1960, cette créatrice de mode britannique a popularisé la minijupe.', '/path/to/image43.jpg'),
(15, 3, 'Quel type de bijoux, souvent portés dans les années 1980, impliquait plusieurs bracelets en caoutchouc portés à la fois, popularisés par Madonna?', '/path/to/image44.jpg'),
(15, 3, 'Dans les années 1980, les femmes portaient souvent des hauts surdimensionnés avec des pantalons ou des leggings moulants et ce type de chaussures.', '/path/to/image45.jpg'),
(15, 3, 'Quelle marque de sac à main est devenue célèbre dans les années 1980 pour ses sacs matelassés avec une bandoulière en chaîne?', '/path/to/image46.jpg'),
(15, 3, 'Dans les années 1970, quel accessoire est devenu populaire, caractérisé par sa forme ronde et ses verres colorés, souvent miroir?', '/path/to/image47.jpg'),
(15, 3, 'Dans les années 1980, les vestes "Members Only" sont devenues un article de mode populaire. Quelle caractéristique distinctive avaient-elles?', '/path/to/image48.jpg'),
(15, 3, 'Ces colliers, souvent faits de perles en plastique, sont devenus un accessoire populaire dans les années 1990.', '/path/to/image49.jpg'),
(15, 3, 'Dans les années 1970, ces pantalons évasés sont devenus un incontournable de la mode.', '/path/to/image50.jpg');
